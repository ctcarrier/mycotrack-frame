...
(defn contam-project-button [desc count selected-culture-id selected-container-id selected-substrate-id selected-location-id]
...
(defn contam-project-form []
  (let [desc (reagent/atom "")
    ...
    (fn []  [:form.col-md-4.col-xs-12.col-md-offset-4
             ...
             [:div.col-xs-12 [contam-project-button desc count selected-culture-id selected-container-id selected-substrate-id selected-location-id]]])))
